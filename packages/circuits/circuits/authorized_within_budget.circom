...
///
/// batchHeight   — altura del árbol del lote (6 → 64 pagos). Tiene que coincidir
///                 con DEFAULT_TREE_HEIGHT en contracts/src/commitment.ts, que
///                 explica por qué son 64 y no otra cosa.
